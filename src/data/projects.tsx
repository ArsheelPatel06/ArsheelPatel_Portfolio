...
const projects: Project[] = [
  {
    ...
    screenshots: [],
    live: "https://github.com/ArsheelPatel06/AirSense-OS",
    github: "https://github.com/ArsheelPatel06/AirSense-OS",
    skills: {
      frontend: [
      ...
      return (
        <div>
          <TypographyP className="font-mono text-2xl text-center">
            AirSense OS - An innovative project
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <TypographyP className="font-mono ">
            An advanced operating system project built with modern technologies. 
            Features 3D animated buttons and a common tech stack.
          </TypographyP>
        </div>
      );
    },
  },
  {
    ...
    screenshots: [],
    live: "https://life-lens-flax.vercel.app/",
    github: "https://github.com/ArsheelPatel06/LifeLens_Hackarena2.0",
    skills: {
      frontend: [
        PROJECT_SKILLS.react,
        PROJECT_SKILLS.tailwind,
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono text-2xl text-center">
            LifeLens - Hackarena 2.0
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <TypographyP className="font-mono ">
            A revolutionary hackathon project offering advanced capabilities.
          </TypographyP>
        </div>
      );
    },
  },
  {
    ...
    src: "", // placeholder
    screenshots: [],
    live: "https://github.com/ArsheelPatel06/DeepCheck",
    github: "https://github.com/ArsheelPatel06/DeepCheck",
    skills: {
      frontend: [
        PROJECT_SKILLS.react,
        PROJECT_SKILLS.tailwind,
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono text-2xl text-center">
            DeepCheck - Deep Learning Validation
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <TypographyP className="font-mono ">
            DeepCheck utilizes machine learning for deep validation and checks.
          </TypographyP>
        </div>
      );
    },

...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Abhimukh Ai",
    description: [
      "Worked on AI research and development.",
      "Implemented and optimized various AI models.",
    ],
    skills: [
      SkillNames.JS,
      SkillNames.TS,
  ...
  },
  {
    ...
    description: [
      ...
      "Ensured software reliability and reported bugs.",
    ],
    skills: [
      SkillNames.JS,
      SkillNames.HTML,
...
export const ACHIEVEMENTS = [
  { id: 1, title: "Build & Grow Hackathon Win", link: "https://lnkd.in/p/dvWMXbvT", image: "/images/journey-11.jpeg" },
  { id: 2, title: "Summer Hacks", link: "#", image: "/images/journey-2.jpeg" },
  { id: 3, title: "Empresserio Ahmedabad National Level", link: "#", image: "/images/journey-5.jpeg" },
  { id: 4, title: "Vidyalankar Clg Competition", link: "https://lnkd.in/p/d4x6-8vP", image: "/images/image copy 2.png" }
];
...
export const JOURNEY_IMAGES = Array.from({ length: 13 }, (_, i) => ({
  id: i + 1,
  src: `/images/journey-${i + 1}.jpeg`,
  title: `Journey Highlight ${i + 1}`,
  description: "A memorable moment from my tech journey and hackathons.",
  date: "2026",
}));
